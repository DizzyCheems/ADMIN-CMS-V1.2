                    ...
                    <div class="content">
                        <div class="module">    
                            ...
                            <div class="module-option clearfix">
                                ...
                                <a class="btn btn-small btn-primary" href="{{route('executive_songregister_view')}}"  >Register New Song</a>
                                        ...
                                        <div class="media user">
                                            ...
                                            <div class="media-body">    
                                                ...
                                                <p>                   
                                                    ...
                                                    <small class="muted">{{$artist['author']}}</small></p>
                                                <div class="media-option btn-group shaded-icon">
                                                    
                                                    <button class="btn btn-small" data-toggle="modal" data-target="#exampleModal">
                                                        <i class="icon-envelope"></i>
                                                    </button>   
                                                    <a button class="btn btn-small" href="{{route('executive_songupdate', $artist ['id'])}}">
                                                        <i class="icon-share-alt"></i>
                                                    </a>    
                                                                        
                                                                                                                                                            
                                                <a class="btn btn-small" href="{{route('executive_artistsdelete', $artist ['id'])}}" >
