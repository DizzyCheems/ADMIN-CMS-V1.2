                    ...
                    <div class="content">   
                        <div class="module">
                            ...
                            <div class="module-option clearfix">
                                ...
                                <a class="btn btn-small btn-primary" href="{{route('executive_artistregister')}}"  >Register New Artist</a>
                                    ...
                                    <div class="span6">
                                        <div class="media user">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p>
                                                    <small class="muted">{{$artist['genre']}}</small></p>
                                                <div class="media-option btn-group shaded-icon">
                                                    ...
                                                    <a button class="btn btn-small" href="{{route('executive_artitsprofileupdate_view', $artist['id'])}}">
                                                        <i class="icon-share-alt"></i>
                                                    </button>
                                                              
                                                    <a class="btn btn-small" href="{{route('executive_artistsdelete_view', $artist['id'])}}">
