...
@endif
	...
	<div class="form-group input-group">	
        ...
        <input name="name" class="form-control" placeholder="Product Name" type="text" value="{{$product['name']}}">
    ...
    <div class="form-group input-group">
    	...
    	<input name="quantity" class="form-control" placeholder="Quantity" type="text" value="{{$product['quantity']}}">
