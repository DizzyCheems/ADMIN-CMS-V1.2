...
<head>
<title>TENTACIT|Employee List|Admin|Control</title>
</head>
                    ...
                    <div class="content">   
                        <div class="module">
                            ...
                            <div class="module-option clearfix">
                                ...
                                <a class="btn btn-small btn-primary" href="{{route('executive_employeeregister')}}"  >Register New Employee</a>
                                ...
                                <div class="row-fluid">
                                    <div class="span6">
                                        <div class="media user">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p>
                                                    <small class="muted">{{$employees['email']}}</small></p>
                                                ...
                                                <button class="btn btn-small" data-toggle="modal" data-target="#exampleModal">
                                                    ...
                                                    <a button class="btn btn-small" href="{{route('executive_employeeupdate', $employees['id'])}}">
                                                        <i class="icon-share-alt"></i>
                                                    </button>

                                                    <a button class="btn btn-small" href="{{route('executive_employeeprofile',  $employees['id'])}}">
                                                        <i class=  "menu-icon icon-cog"></i>
                                                    </a>                          
                                                              
                                                    <a class="btn btn-small" href="{{route('executive_employeedelete',$employees['id'])}}">
                                    ...
                                    @endforeach
                                        ...
                                        <div class="span6">
                                            <div class="media user">
                                                <a class="media-avatar pull-left" href="#">
                                                    <img src="icon-user-default-420x420.png">
                                                </a>
                                                <div class="media-body">
                                                    <h3 class="media-title">
                                                        NULL</h3>
