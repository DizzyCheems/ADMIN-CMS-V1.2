                    ...
                    <div class="content">   
                        <div class="module">
                            ...
                            <div class="module-option clearfix">
                                ...
                                <a class="btn btn-small btn-primary" href="{{route('executive_document_register')}}"  >Submit New Document</a>
                                ...
                                <div class="row-fluid">
                                    <div class="span6">
                                        <div class="media user">
                                            ...
                                            <img src="/documents.png" width="100px">
                                            </a>
                                            ...
                                            <div class="media-body">
                                              ...
                                              {{$docs['name']}}
                                                ...
                                                <p>
                                                    <small class="muted">{{$docs['timestamps']}}</small></p>
                                                ...
                                                <button class="btn btn-small" data-toggle="modal" data-target="#exampleModal">
                                                    ...
                                                    <a button class="btn btn-small" href="#">
                                                        <i class="icon-share-alt"></i>
                                                    </button>
                                                                          
                                                    <a class="btn btn-small" href="{{route('executive_document_delete', $docs['id'])}}">
